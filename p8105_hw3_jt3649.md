...
\##### Comment on the plot The plot shows general upward trends in
rental prices across all five boroughs. Manhattan has the largest
difference in price levels each year and has the greatest fluctuation in
rental prices over the years. Manhattan, Brooklyn, and Queens have a
noticeable drop in rental prices around 2021, which might be related to
the pandemic. But the drop is followed by recovery and growth. Price
data for Staten Island is the most limited.
